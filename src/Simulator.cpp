...
static std::map<Message, cmdDetails> simCmd =
{
    ...
    { 
        {{0x06, 0x20}}, { {{0x20, 0x01, 0x02, 0x04}},
        "state", R"({ "mode":"LBR", "neighbors":2, "discoveryState":4 })", }
    },  
    { 
        {{0x06,0x24}}, { {{0x24,0x01,0x0ff,0x0f,0xfe,0xff,0xf9,0x19,0x00}},
        "mac", R"({ "mac":"00:19:59:ff:fe:0f:ff:01" })", }
    },
    { 
        {{0x06, 0x21, 0x01}}, { {{0x21,0x01,0x42,0xfc,0x42,0x00,0x6f,0x00,0x00,0x00,0x00,0x00,0x01,0xe3,0x00,0x00,0xfe,0xca,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x01,0xff,0x0f,0xfe,0xff,0x59,0x19,0x00}},
...
#else
        {{0x06,0x23,}},{ {{0x23,0x02,0x00,0x01,0x7e,0x02,0x4e,0x00,0x02,0xff,0x0f,0xfe,0xff,0x59,0x19,0x00,0x01,0x01,0x7f,0x02,0x4e,0x00,0x03,0xff,0x0f,0xfe,0xff,0x59,0x19,0x00 }},
